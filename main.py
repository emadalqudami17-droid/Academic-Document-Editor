...
class EditorScreen(Screen):
    ...
    def open_document(self, doc_id):
        ...
        self.doc_id = data.get(
            "id"
        )

        self.doc_created = data.get(
            "created"
        )
...
class AcademicWordEditorApp(App):
    ...
    def build(self):
        ...
        print(
            f"[APP] Storage: {STORAGE_DIR}"
        )

        print(
            f"[APP] Font loaded: {FONT_LOADED}"
        )
